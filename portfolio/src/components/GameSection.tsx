    ...
    <div className="container col-xxl-8 px-4 py-5">
      <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div className="col-lg-6">
          <h1 className="h1 fw-bold text-body-emphasis lh-1 mb-3">Game: 8 Bit Survivor</h1>
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-start">
            <a href="https://play.google.com/store/apps/details?id=com.glrtdev.EightBitSurvivor" type="button" className="btn btn-primary btn-lg px-4 me-md-2 rounded-pill">
