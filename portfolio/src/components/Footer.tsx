...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="mt-auto py-4 bg-body-tertiary border-top">
      <div className="container px-4">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
          {/* Left Column: Branding / Copyright */}
          <div className="text-center text-md-start">
            <span className="fw-semibold text-body-emphasis fs-6 me-1">
          ...
          {/* Center Column: Built With Badges */}
          <div className="d-flex align-items-center gap-2">
            <span className="text-body-secondary small">Built with</span>
            <span className="badge text-bg-secondary rounded-pill">React</span>
            <span className="badge text-bg-secondary rounded-pill">TypeScript</span>
            <span className="badge text-bg-secondary rounded-pill">Bootstrap</span>
          </div>
          ...
          <div className="d-flex align-items-center gap-3">
            {githubUrl && (
              <a
                ...
                className="text-body-secondary text-decoration-none hover-highlight"
            ...
            {email && (
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-envelope-fill" viewBox="0 0 16 16">
                  ...
                  <path d="M0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zM10.197 8.243L16 11.801V4.697z"/>
                </svg>
              </a>
            )}
          </div>
